...
<style>
    .onepage2-bnr {
        background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.572) , rgba(0, 0, 0, 0.472)), url(./img/banner-bg-1.jpg) ;
...
<body>
    ...
    <section class="onepage2-bnr">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-lg-6">
                    <h1 class="pb-3">we are smart creative agency</h1>
                    <p class="fs-6 pb-4 text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nulla, ad rerum repellat. Sequi, labore,
                        illo. Ducimus voluptates quidem obcaecati, ad.</p>
                    <div class="row">
                        <div class="col-12">
                            <a href="" class="butn fw-normal mx-1">explore us</a>
                            <a href="" class="butn bg-transparent mx-1 border fw-normal">learn more</a>
                        </div>
                    </div>
                </div>
            </div>
